...
from PyQt6.QtCore import Qt, QThread, QRectF, QSize
...
## 1.1 -- Layout à retour à la ligne automatique (pour les "chips" de région) --
...
## 1.2 -- Thème de couleurs des cartes de recommandation -----------------------
