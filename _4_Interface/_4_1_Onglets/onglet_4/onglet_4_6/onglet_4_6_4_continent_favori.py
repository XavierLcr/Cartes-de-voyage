...
class ContinentFavoriWidget(QWidget):
    ...
    def _dessiner_badge_globe(self, painter: QPainter, rect: QRectF) -> None:
        ...
        degrade.setColorAt(0.0, self.theme.badge_debut.lighter(122))
        degrade.setColorAt(0.42, self.theme.badge_debut)
        degrade.setColorAt(0.75, bleu_ocean)
        degrade.setColorAt(1.0, self.theme.badge_fin.darker(118))
        ...
        couleur_terre = self.theme.badge_fin.darker(135)
